...
public class Exercise14_05 extends Exercise {
    ...
    protected void runExercise() {
        ...
        try {
            // The null in invoke() indicates there are no parameters being
            // passed to the doSomething method
            method = myclass.getClass().getMethod("doSomething", null);
            method.invoke(myclass, null);
            
            // String.class is the type of the input, while the input is passed
            // in invoke()
        ...
        try {
            // Using getDeclaredMethod() instead of getMethod() to invoke a
            // private method
