...
public class WordBreak extends Exercise {
    ...
    public boolean test() {
        for (int index = 0; index < testSuite.length; index++) {
            ...
            boolean isSegmentable = wordBreak(test.string, new HashSet<String>(test.dictionary));
            
            System.out.printf("%s %s be segmented by words from this dictonary:", 
                    test.string, ((isSegmentable)? "can" : "cannot"));
